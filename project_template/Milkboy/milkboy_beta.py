...
class PlayerCharacter(arcade.Sprite):
    ...
    def __init__(self):
        ...
        main_path = "assets/milkboy"
        # main_path = ":resources:images/animated_characters/male_adventurer/maleAdventurer"
        # main_path = ":resources:images/animated_characters/zombie/zombie"
        # main_path = ":resources:images/animated_characters/robot/robot"

        # Load textures for idle standing
        self.idle_texture_pair = load_texture_pair(f"{main_path}\Milkboy01.png")
        self.jump_texture_pair = load_texture_pair(f"{main_path}\milkboy_jump.png")
        self.fall_texture_pair = load_texture_pair(f"{main_path}\milkboy_jump.png")

        # Load textures for walking
        self.walk_textures = []
        for i in range(8):
            texture = load_texture_pair(f"{main_path}\milkboy_walk\milkboy_walk-{i}.png")
        ...
        self.idle_textures = []
        for i in range(8):
            texture = load_texture_pair(f"{main_path}\milkboy_idle\milkboy_idle-{i}.png")
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        map_name = "maps/beta_test_map.tmx"
